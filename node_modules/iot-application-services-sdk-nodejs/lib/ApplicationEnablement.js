...
class ApplicationEnablement {
    ...
    setBaseUrl(microservice) {
        ...
        const MICROSERVICES = [
            ...
            'composite-things', 'composite-things-odata', 'composite-events-odata'
        ]; // a list of all available microservices
    ...
    async request(requestConfig) {
        ...
        try {
            ...
            if (error.statusCode == 406) {//if error is due to Accept JSON, try without it
                try {
                    response = await rp({
                        url: this.getRequestUrl(url),
                        method,
